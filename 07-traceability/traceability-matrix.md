...
- Поиск по фото: форматы/лимиты (JPG/PNG ≤10 МБ) отражены в тестах как ожидаемые ограничения. Если требования изменятся — обновить TC-AI-003..TC-AI-006 и US-SRCH-5.
- Наличие CTA «Смотреть все результаты» — зафиксировано как UX-ожидание/дефект (BUG-003) и требует подтверждения требованиями/макетами.
